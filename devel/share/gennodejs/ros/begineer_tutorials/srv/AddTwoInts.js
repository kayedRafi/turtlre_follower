...
// (in-package begineer_tutorials.srv)
...
class AddTwoIntsRequest {
  ...
  static datatype() {
    ...
    return 'begineer_tutorials/AddTwoIntsRequest';
  }
...
class AddTwoIntsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'begineer_tutorials/AddTwoIntsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'begineer_tutorials/AddTwoInts'; }
};
